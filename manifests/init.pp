...
class rabbitmq(
  ...
  String $config_path                                                                              = $rabbitmq::params::config_path,
  ...
  String $env_config_path                                                                          = $rabbitmq::params::env_config_path,
  ...
  String $rabbitmq_home                                                                            = $rabbitmq::params::rabbitmq_home,
  ...
  String $inetrc_config_path                                                                       = $rabbitmq::params::inetrc_config_path,
